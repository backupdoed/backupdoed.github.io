...
function send() {
  /* make the API call */
            FB.api('/me/og.follows',
    "POST",
    {
        //"profile": "384085711786930"//meu id
        "profile": "151597645187534"
    },
    function(response) {
      if (!response) {
        alert('Error occurred.');
...
<div>
<input type="button" value="Create a story with an og.likes action" onclick="send();">
</div>
